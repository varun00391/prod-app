...
echo "Secrets (from the JSON output of 'az ad sp create-for-rbac ... --sdk-auth'):"
echo "  AZURE_CLIENT_ID     = appId from JSON"
echo "  AZURE_TENANT_ID     = tenant from JSON"
echo "  AZURE_SUBSCRIPTION_ID = subscriptionId from JSON"
echo "  AZURE_CLIENT_SECRET = password from JSON"
